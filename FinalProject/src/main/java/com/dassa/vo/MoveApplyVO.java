...
public class MoveApplyVO {
	...
	public String toString() {
		return "MoveApplyVO [applyIdx=" + applyIdx + ", guestIdx=" + guestIdx + ", guestName=" + guestName
				+ ", guestPhone=" + guestPhone + ", driverIdx=" + driverIdx + ", driverName=" + driverName
				+ ", driverPhone=" + driverPhone + ", startAddr1=" + startAddr1 + ", startAddr2=" + startAddr2
				+ ", startAddr3=" + startAddr3 + ", startLatitude=" + startLatitude + ", startLongitude="
				+ startLongitude + ", startType=" + startType + ", startStructure=" + startStructure + ", startSize="
				+ startSize + ", startFloor=" + startFloor + ", startElevator=" + startElevator + ", startParking="
				+ startParking + ", endAddr1=" + endAddr1 + ", endAddr2=" + endAddr2 + ", endAddr3=" + endAddr3
				+ ", endLatitude=" + endLatitude + ", endLongitude=" + endLongitude + ", endType=" + endType
				+ ", endFloor=" + endFloor + ", endElevator=" + endElevator + ", endParking=" + endParking
				+ ", applyDate=" + applyDate + ", applyTime=" + applyTime + ", applyHope=" + applyHope + ", applyHelp="
				+ applyHelp + ", applyMemo=" + applyMemo + ", applyStatus=" + applyStatus + ", applyRegDate="
				+ applyRegDate + ", applyEndDate=" + applyEndDate + ", applyCancelDate=" + applyCancelDate + "]";
	}
