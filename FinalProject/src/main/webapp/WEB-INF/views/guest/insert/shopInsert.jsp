				...
				<form action="/insert/commonInsert" method="post">
					<table class="commonInsert_table">
						...
						<tr>
							<th>중개등록번호</th>
							<td>
								<input type="text" class="tbox normal" name="userRegNum" id="uRegNum">
							</td>
						</tr>
						<tr>
							<th>중개등록증 첨부</th>
							<td>
								<input type="file" class="tbox normal" name="userRegFile" id="uRegFile">
							</td>
						</tr>
						...
						<tr>
							<th>사업자등록번호</th>
							<td>
								<input type="text" class="tbox normal" name="userBusNum" id="uBusNum">
							</td>
						</tr>
						<tr>
							<th>사업자등록증 첨부</th>
							<td>
								<input type="file" class="tbox normal" name="userBusFile" id="uBusFile">
							</td>
						</tr>		
					</table>
