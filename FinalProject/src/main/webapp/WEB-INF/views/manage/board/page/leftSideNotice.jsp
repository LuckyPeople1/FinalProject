		...
		<ul class="lnb_menu">
			...
			<li>
				...
				<ul class="lnb_sub_menu">
					...
					<li><a href="/manage/board/faq/faqManageList?reqPage=1&code=1" class="">부동산 FAQ 관리</a></li>
					<li><a href="/manage/board/question/questionManageList?reqPage=1&code=1" class="">부동산 1:1 문의 관리</a></li>
				</ul>
			</li>
			<li>
				...
				<ul class="lnb_sub_menu">
					...
					<li><a href="/manage/board/faq/faqManageList?reqPage=1&code=2" class="">기사 FAQ 관리</a></li>
					<li><a href="/manage/board/question/questionManageList?reqPage=1&code=2" class="">기사 1:1 문의 관리</a></li>
				</ul>
			</li>			
		</ul>
	</div>
