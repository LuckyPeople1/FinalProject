		...
		<div class="contents">
			<div class="set_field">
				<div class="field_title">
					<span class="title_mark">■ 기사 공지사항 관리</span>
				</div>
				...
				<div class="list_field">
					...
					<span class="right_menu">
						...
						<a href="/manage/board/notice/articles/noticeManageArticlesWriter" class="btn col_darkGrey f_w">글쓰기</a>
					</span>
				</div>
