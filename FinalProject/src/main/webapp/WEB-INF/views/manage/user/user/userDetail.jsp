				...
				<div class="set_field">
					...
					<section class="section_notice">
						<table class="set_table">
							...
							<tr>
								<th>등록파일</th>
								<td><img class="detail_img" style="width:100px; height:100px;" src="${compFilepath1 }"></td>
							</tr>
							<tr>
								<th>등록 번호</th>
							...
							<tr>
								<th>등록파일</th>
								<td><img class="detail_img" style="width:100px; height:100px;" src="${compFilepath2 }"></td>
							</tr>
							<tr>
								<td colspan="2">
