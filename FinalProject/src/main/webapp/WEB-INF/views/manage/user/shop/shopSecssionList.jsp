...
<div class="container">
	...
	<div class="wrapper">
		...
		<div class="contents">
			<div class="set_field">
				<div class="field_title"><span class="title_mark">■ 부동산 탈퇴 관리</span></div>
			...
			<table class="list_table">
				...
				<tbody>
					<c:choose>
						<c:when test="${not empty list }">
							<c:forEach var="u" items="${list}" varStatus="i">
								<tr>
									...
									<td>${u.outDate }</td>
									<td>
										<a href="javascript:realDel(${u.userIdx })" id="del_btn" class="tag col_darkGrey f_w">${u.userStatus}</a>
									</td>
								</tr>
							</c:forEach>
						</c:when>
						<c:otherwise>
							<tr>
								<td colspan="10">탈퇴된 회원 목록이 없습니다.</td>
							</tr>
						</c:otherwise>
					</c:choose>
				</tbody>
