		...
		<section class="contents package">
			<form id="regFrm" name="regFrm">
				<div class="set_field">
					...
					<table class="set_table">
						...
						<tr>
							...
							<td>
								<label class="chk">
									<input type="radio" name="packageType" value="0" ${item.packageType == 0 ? 'checked' : ''}>
									<span>가전</span>
								</label>
								<label class="chk ml10">
									<input type="radio" name="packageType" value="1" ${item.packageType == 1 ? 'checked' : ''}>
									<span>가구</span>
								</label>
								<label class="chk ml10">
									<input type="radio" name="packageType" value="2" ${item.packageType == 2 ? 'checked' : ''}>
									<span>기타</span>
								</label>
							</td>
						</tr>
						<tr>
							<th>짐 이름</th>
							<td>
								<input class="tbox full" id="packageName" name="packageName" value="${item.packageName}">
							</td>
						</tr>
						<tr>
							<th>짐 아이콘 등록</th>
							<td>
								<div class="img_up_list">
									<div class="img_box">
										...
										<a href="#none" class="del_btn" onclick="package.delImg(this)">삭제</a>
									</div>
								</div>
							</td>
						</tr>
				...
				<div class="btn_group">
					...
					<a href="javascript:package.packageReg()" class="btn col_main">수정</a>
				</div>
			</form>
