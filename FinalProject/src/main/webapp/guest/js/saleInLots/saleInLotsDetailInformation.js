$(document).ready(function(){
	...
	if($(".minprice").html().length < 19){
		$(".minprice").html("최저 분양가 : "+minstr.substring(9,10)+"억 "+minstr.substring(10,14)+"만원");
	}else{
		$(".minprice").html("최저 분양가 : "+minstr.substring(9,10)+"억 "+minstr.substring(10,14)+"만원");
	}
	if($(".maxprice").html().length < 19){
		$(".maxprice").html("최고 분양가 : "+maxstr.substring(9,10)+"억 "+maxstr.substring(10,14)+"만원");
	}else{
		$(".maxprice").html("최고 분양가 : "+maxstr.substring(9,11)+"억 "+maxstr.substring(11,15)+"만원");
	}
